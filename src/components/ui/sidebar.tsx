  ...
  (
    ...
    return (
        <aside
          ref={ref}
          className={cn(
              "group fixed inset-y-0 z-40 hidden h-svh flex-col transition-all duration-300 ease-in-out md:flex",
...
>(({ className, onClick, children, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="default"
      className={cn("h-11 md:w-full md:justify-start", state === 'collapsed' && 'md:justify-center', className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
  ...
  (
    ...
    const button = (
      <Comp
        ...
        state === "collapsed" && "justify-center w-12 h-12 p-2",
        className)}
        {...props}
      >
        {children}
